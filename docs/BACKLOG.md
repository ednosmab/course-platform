...
- **[Done] Remover Fundo:** Testar algoritmo de remoção de fundo (Edge Detection + Boundary Fill) com imagem real no Studio.
...
- **[Done] Preview de Certificado:** Validação de fidelidade visual entre Studio e impressão (A4).
