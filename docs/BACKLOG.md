...
| 🛡️ Controlo de Acesso a Cursos via Planos (SaaS Multi-Tenant) | 🟠 Alto | Backlog | 2026-08-15 | unassigned |

**Detalhe Controlo de Acesso:** Sistema de controlo de acesso a cursos no modelo SaaS. Admin configura por curso (Livre/Progressivo/Restrito) na tela de configurações (acima do toggle de publicação). Aluno vê estado na tela "Explorar Cursos". Plano completo: `docs/plans/2026-06-10-controlo-acesso.md` | Workflow: `docs/workflows/workflow_adm.md` secção 11.
