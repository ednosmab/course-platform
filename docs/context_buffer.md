...
- Reestilizados o card Hero/Welcome (borda verde e sombra), cards de Estatísticas (bordas esquerda coloridas, sombras e micro-interação de escala) e cards de Cursos da home (borda verde em publicados, gradiente fallback esmeralda e ponto de status pulsante dinâmico).
