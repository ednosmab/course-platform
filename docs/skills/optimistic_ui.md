...
## 🎯 Objetivo
Proporcionar uma percepção de velocidade instantânea ao usuário, tratando a sincronização com o Supabase como um processo de background transparente.
...
| :--- | :--- | :--- |
| `synced` | Salvo no Supabase | Sem ícone (limpo). |
