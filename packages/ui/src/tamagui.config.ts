...
const config = createTamagui({
  ...
  themes: {
    dark: {
      ...
      dangerSurface: tokens.color.danger,
      dangerSurfaceHover: tokens.color.warning,
      dangerBorder: tokens.color.danger,
    ...
    cloudWhite: {
      ...
      successSurface: tokens.color.cwSuccessSurface,
      successSurfaceHover: tokens.color.cwSuccessSurfaceHover,
      successBorder: tokens.color.cwSuccessBorder,
      warning: tokens.color.warning,
      ...
      destructiveSurface: tokens.color.cwDestructiveSurface,
      destructiveSurfaceHover: tokens.color.cwDestructiveSurfaceHover,
      destructiveBorder: tokens.color.cwDestructiveBorder,
      dangerSurface: tokens.color.cwDestructiveSurface,
      dangerSurfaceHover: tokens.color.cwDestructiveSurfaceHover,
      dangerBorder: tokens.color.cwDestructiveBorder,
